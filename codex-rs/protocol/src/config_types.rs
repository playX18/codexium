...
pub const TUI_VISIBLE_COLLABORATION_MODES: [ModeKind; 3] =
    [ModeKind::Default, ModeKind::Plan, ModeKind::Compose];
...
impl ModeKind {
    ...
    pub const fn is_tui_visible(self) -> bool {
        matches!(self, Self::Plan | Self::Default | Self::Compose)
    }

    pub const fn allows_request_user_input(self) -> bool {
        matches!(self, Self::Plan | Self::Compose)
    }
}
...
mod tests {
    ...
    fn tui_visible_collaboration_modes_match_mode_kind_visibility() {
        let expected = [ModeKind::Default, ModeKind::Plan, ModeKind::Compose];
