...
Dispatch an implementer subagent via `spawn_agent`, using a distinct `task_name` for the plan task. Use a message like "Implement Task N: [task name]" and give it this prompt:
